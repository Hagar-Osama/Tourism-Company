...
<div id="content" class="main-content">
    <div class="container">
        <div class="container my-5 mx-auto">
            ...
            <form class="form-vertical" action="{{route('admin.package.update')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input type="hidden" name="package_id" value="{{$package->id}}">
                <div class="form-group mb-4">
                    <label class="control-label">Title:</label>
                    <input type="text" name="title" class="form-control @error('title') is-invalid fparsley-error parsley-error @enderror" placeholder="Title" value="{{$package->title}}">
                    @error('title')
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" name="location" class="form-control @error('location') is-invalid fparsley-error parsley-error @enderror" placeholder="Location" value="{{$package->location}}">
                    @error('location')
                    <span class="invalid-feedback text-danger" role="alert">
                        <p>{{ $message }}</p>
                    </span>
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="number" name="price" class="form-control @error('price') is-invalid fparsley-error parsley-error @enderror" placeholder="Price" value="{{$package->price}}">
                    @error('price')
                    <span class="invalid-feedback text-danger" role="alert">
                        <p>{{ $message }}</p>
                    </span>
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="date" name="start_date" class="form-control @error('start_date') is-invalid fparsley-error parsley-error @enderror" placeholder="Date" value="{{$package->start_date}}">
                    @error('start_date')
                    <span class="invalid-feedback text-danger" role="alert">
                        <p>{{ $message }}</p>
                    </span>
                ...
                <div class="clipboard">
                    <div class="input-group mb-4">
                        ...
                        <textarea id="editor" class="form-control @error('body') is-invalid fparsley-error parsley-error @enderror" aria-label="With textarea" name="body">{!! $package->body !!}</textarea>
                    </div>
                    @error('body')
                    <span class="invalid-feedback text-danger" role="alert">
                        <p>{{ $message }}</p>
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="file" name="plan_pdf" class="form-control @error('plan_pdf') is-invalid fparsley-error parsley-error @enderror" placeholder="PLAN PDF">
                    @error('plan_pdf')
                    <span class="invalid-feedback text-danger" role="alert">
                        <p>{{ $message }}</p>
                    </span>
                ...
                <div class="custom-file-container" data-upload-id="myFirstImage">
                    <label>Upload (Multi Files) <a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image">x</a></label>
                    <label class="custom-file-container__custom-file">
