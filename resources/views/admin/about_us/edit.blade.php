    ...
    <div id="content" class="main-content">
        <div class="container">
            <div class="container my-5 mx-auto">
                ...
                <form class="form-vertical" action="{{route('admin.about.update')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="about_id" value="{{$about->id}}">
                    <div class="form-group mb-4">
                        <label class="control-label">Slug:</label>
                        <input type="text" name="slug" class="form-control @error('slug') is-invalid fparsley-error parsley-error @enderror" placeholder="English Name" value="{{$about->slug}}">
                        @error('slug')
                    ...
                    <div class="clipboard">
                        <div class="input-group mb-4">
                            ...
                            <textarea id="editor" class="form-control @error('body') is-invalid fparsley-error parsley-error @enderror" aria-label="With textarea" name="body">{!! $about->body !!}</textarea>
                        </div>
                        @error('body')
                        <span class="invalid-feedback text-danger" role="alert">
                          <p>{{ $message }}</p>
                    ...
                    @if ($about->image)
                        <div class="custom-file-container__image-preview">
                            <img src="{{env('AWS_URL'). '/abouts'. "/" .$about->image}}" class="rounded-circle profile-img text-center" width="650px" height="250px" alt="avatar">
                        </div>
                    @endif
