    ...
    <div id="content" class="main-content">
        <div class="container">
            <div class="container my-5 mx-auto">
                ...
                <form class="form-vertical" action="{{route('admin.assets.update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="slug" class="form-control @error('slug') is-invalid fparsley-error parsley-error @enderror"  value="{{$asset->slug}}">
                        @error('slug')
