    ...
    <div id="content" class="main-content">
        <div class="container">
            <div class="container my-5 mx-auto">
                ...
                <form class="form-vertical" action="{{route('admin.assets.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group mb-4">
                        <label class="control-label">Asset Slug:</label>
                        <input type="text" name="slug" class="form-control @error('slug') is-invalid fparsley-error parsley-error @enderror" placeholder="asset slug" value="{{old('slug')}}">
                        @error('slug')
