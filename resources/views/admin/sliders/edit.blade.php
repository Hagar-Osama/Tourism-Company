    ...
    <div id="content" class="main-content">
        <div class="container">
            <div class="container my-5 mx-auto">
                ...
                <form class="form-vertical" action="{{route('admin.slider.update')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="slider_id" value="{{$slider->id}}">
                    <div class="form-group mb-4">
                        <label class="control-label">Slider Link:</label>
                        <input type="text" name="link" class="form-control @error('link') is-invalid fparsley-error parsley-error @enderror"  value="{{$slider->link}}">
                        @error('link')
