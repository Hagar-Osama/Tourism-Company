                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex my-xl-auto right-content">
                                            <form method="post" action="{{route('admin.contact.destroy')}}">
                                                @csrf
                                                @method('DELETE')
                                                <input type="hidden" name="message_id" value="{{$message->id}}">
                                                <div class="pr-1 mb-3 mb-xl-0">
                                                    <button type="submit" class="btn btn-danger btn-icon mr-2 delete" data-id="" data-placement="top" data-toggle="tooltip" title="Delete">Delete</button>
                                                </div>
                                            </form>
                                        </div>
                                    </td>
