        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu active">
                ...
                <ul class="collapse submenu recent-submenu mini-recent-submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="{{route('user.index')}}"> Store live </a>
                    </li>
                </ul>
            </li>
...
{{--            </li>--}}
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="components" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.category.index')}}"> Show All Categories </a>
                    </li>
                    <li>
            ...
            <!-- Assets -->
            <li class="menu">
                <a href="#assets" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-box"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
                        <span>Assets</span>
                    </div>
                ...
                <ul class="collapse submenu list-unstyled" id="assets" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.assets.index')}}"> Show All Assets </a>
                    </li>
                    <li>
                        <a href="{{route('admin.assets.create')}}"> Create New Asset </a>
                    </li>
                </ul>
            </li>
            <!-- Sliders -->
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="sliders" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.slider.index')}}"> Show All Sliders </a>
                    </li>
                    <li>
                        <a href="{{route('admin.slider.create')}}"> Create New Slider </a>
                    </li>
                </ul>
            </li>
            <!-- Gallery -->
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="elements" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.gallery.index')}}"> Show All Gallery </a>
                    </li>
                    <li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="ads" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.ads.index')}}"> Show All Ads </a>
                    </li>
                    <li>
            ...
            <!-- AboutUs -->
            <li class="menu">
                <a href="#about_us" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-zap"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>
                        <span>About</span>
                    </div>
                ...
                <ul class="collapse submenu list-unstyled" id="about_us" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.about.index')}}"> Show All About </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="about_us" data-parent="#accordionExample">
                    <li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="setting" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.setting.index')}}"> Show All Settings </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="setting" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.setting.create')}}"> Create New Setting </a>
                    </li>
                </ul>
            </li>
            <!-- Contacts -->
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="cat_policy" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.contact.index')}}"> Show All Messages </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="cat_policy" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.contact.unread')}}"> Show UnRead Messages </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="partners" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.partners.index')}}"> Show All Partners Images </a>
                    </li>
                    <li>
                        <a href="{{route('admin.partners.create')}}"> Upload New Partner Image </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="package" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.package.index')}}"> Show All Packages </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="package" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.package.create')}}"> Create New Package </a>
                    </li>
                </ul>
            </li>
            <!-- Booking -->
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="booking" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.booking.index')}}"> Show All Booking </a>
                    </li>
                </ul>
            </li>
