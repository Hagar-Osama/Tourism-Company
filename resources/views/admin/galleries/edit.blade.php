...
@section('css')
    <link href="{{URL::asset('assetsAdmin/assets/css/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
    ...
    <div id="content" class="main-content">
        <div class="container">
            <div class="container my-5 mx-auto">
                ...
                <form class="form-vertical" action="{{route('admin.gallery.update')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="gallery_id" value="{{$gallery->id}}">
                    <div class="my-3 text-center"><img src="{{URL::asset('images/galleries/'.$gallery->image)}}" width="600px"></div>
